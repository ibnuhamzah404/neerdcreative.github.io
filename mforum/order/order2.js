...
$(document).ready(function(){
	...
	$("#form2").on("submit", function(event){
	  ...
	  let name  = $("#name2").val(); // mengambil data dari input name
	  let hp = $("#phone2").val(); // mengambil data dari input phone
...
var forms = document.getElementsByTagName('form2');
	for (var i = 0; i < forms.length; i++) {
		forms[i].setAttribute('action', 'order/thanks-indo2.html');
...
jQuery.each( $('form2[action="order/thanks-indo2.html"]'), function( i, val ) {
